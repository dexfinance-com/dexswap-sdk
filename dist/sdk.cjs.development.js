...
var FACTORY_ADDRESS = '0x3e40739d8478c58f9b973266974c58998d4f9e8b';
var FACTORY_ADDRESS_MAP = (_FACTORY_ADDRESS_MAP = {}, _FACTORY_ADDRESS_MAP[exports.ChainId.MAINNET] = FACTORY_ADDRESS, _FACTORY_ADDRESS_MAP[exports.ChainId.TESTNET] = '0x107969c68f01dd1b22647d32af680234982457a4', _FACTORY_ADDRESS_MAP);
var INIT_CODE_HASH = '0x1380cfdf0df827009c1a086d451af646c609434128cafc98e3aa6c812fb35354';
var INIT_CODE_HASH_MAP = (_INIT_CODE_HASH_MAP = {}, _INIT_CODE_HASH_MAP[exports.ChainId.MAINNET] = INIT_CODE_HASH, _INIT_CODE_HASH_MAP[exports.ChainId.TESTNET] = '0xc905a2e51d60ee30c0c7c90b180c0d9e405bdd99290342ddb243ad46be86667c', _INIT_CODE_HASH_MAP);
...
Currency.ETHER = /*#__PURE__*/new Currency(18, 'ETH', 'Ethereum Token');
...
var WETH = (_WETH = {}, _WETH[exports.ChainId.MAINNET] = /*#__PURE__*/new Token(exports.ChainId.MAINNET, '0x82af49447d8a07e3bd95bd0d56f35241523fbab1', 18, 'WETH', 'Wrapped ETH', ''), _WETH[exports.ChainId.TESTNET] = /*#__PURE__*/new Token(exports.ChainId.TESTNET, '0xD1489f4c801647D7c6912d694011854221296cF1', 18, 'WETH', 'Wrapped ETH', ''), _WETH);
...
var Pair = /*#__PURE__*/function () {
  ...
  _proto.getOutputAmount = function getOutputAmount(inputAmount) {
    ...
    var inputAmountWithFee = JSBI.multiply(inputAmount.raw, this._swapFractionAfterFee);
  ...
  _proto.getInputAmount = function getInputAmount(outputAmount) {
    ...
    var denominator = JSBI.multiply(JSBI.subtract(outputReserve.raw, outputAmount.raw), this._swapFractionAfterFee);
...
var ZERO_HEX = '0x0';
/**
 * Represents the DexSwap Router, and has static methods for helping execute trades.
 */
...
var Fetcher = /*#__PURE__*/function () {
  ...
  Fetcher.fetchPairData = function fetchPairData(tokenA, tokenB, swapFee, protocolFeeShare, provider) {
    try {
      ...
      return Promise.resolve(new contracts.Contract(address, IDexSwapPair, provider).getReserves()).then(function (_ref) {
