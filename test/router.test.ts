...
describe('Router', () => {
  const token0 = new Token(ChainId.TESTNET, '0x0000000000000000000000000000000000000001', 18, 't1')
  const token1 = new Token(ChainId.TESTNET, '0x0000000000000000000000000000000000000002', 18, 't2')
